...
check_bbr_status() {
    local param=$(sysctl net.iptembak.tcp_congestion_control | awk '{print $3}')
...
sysctl_config() {
    ...
    sed -i '/net.iptembak.tcp_congestion_control/d' /etc/sysctl.conf
    echo "net.core.default_qdisc = fq" >> /etc/sysctl.conf
    echo "net.iptembak.tcp_congestion_control = bbr" >> /etc/sysctl.conf
